...
class UserRepository extends BaseRepository
{
    ...
    {
        return cache()->rememberForever('user-roles-'.auth()->id(), function () {
    ...
    public function getPermissionsForFrontEnd()
    {
        ...
        return cache()->remember('auth-user-permissions-'.auth()->id()."-".$permissions->count(), 86400, function () use ($permissions) {
