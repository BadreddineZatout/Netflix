<template>
    ...
    <form v-else ref="form" data-url="/admin/app/settings/delivery-settings"
        ...
        <!-- For mandrill -->
        <fieldset v-else-if="emailSettings.provider === 'mandrill'">
            <div class="form-group row align-items-center">
                <label for="mandrillKey" class="col-lg-3 col-xl-3 mb-lg-0">
                    {{ $t('mandrill_key') }}
                </label>
                <div class="col-lg-8 col-xl-8">
                    <app-input id="mandrillKey"
                               type="text"
                               v-model="emailSettings.mandrill_key"
                               :placeholder="$t('mandrill_key')"
                               :required="true"/>
                </div>
            </div>
        </fieldset>
        ...
        <!-- For sparkpost -->
        <fieldset v-else-if="emailSettings.provider === 'sparkpost'">
            <div class="form-group row align-items-center">
                <label for="sparkpostKey" class="col-lg-3 col-xl-3 mb-lg-0">
                    {{ $t('sparkpost_key') }}
                </label>
                <div class="col-lg-8 col-xl-8">
                    <app-input id="sparkpostKey"
                               type="text"
                               v-model="emailSettings.sparkpost_key"
                               :placeholder="$t('sparkpost_key')"
                               :required="true"/>
                </div>
            </div>
        </fieldset>

<!--        &lt;!&ndash; For sendmail &ndash;&gt;-->
<!--        <fieldset v-else-if="emailSettings.provider === 'sendmail'">-->
<!--            <div class="form-group row align-items-center">-->
<!--                <label for="emailSettingsSendMailHost" class="col-lg-3 col-xl-3 mb-lg-0">-->
<!--                    {{ $t('hostname') }}-->
<!--                </label>-->
<!--                <div class="col-lg-8 col-xl-8">-->
<!--                    <app-input id="emailSettingsSendMailHost"-->
<!--                               type="text"-->
<!--                               v-model="emailSettings.sendmail_path"-->
        ...
        data() {
            return {
                ...
                providerList : [
                    ...
                    {id: 'mandrill', value: this.$t('mandrill')},
                    {id: 'sparkpost', value: this.$t('sparkpost')},
