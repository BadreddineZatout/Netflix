    ...
    export default {
        ...
        computed: {
            all_tags() {
                const tags = Object.keys(this.tags).filter(tag => {
                    ...
                    }else if('password-reset' === this.notificationEventName) {
        ...
        methods : {
            ...
            addTag(tag_name = '{name}') {
                ...
                if (tag_name == '{app_logo}') $("#text-editor-for-template").summernote('pasteHTML', '<img src="{app_logo}" style="height: 75px"/>');
