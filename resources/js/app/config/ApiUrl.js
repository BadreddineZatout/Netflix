...
//Dashboard
export const ADMIN = 'default-dashboard';
export const DEFAULT_INFO = 'default-info';
export const PANNES_ABONNEMENT = 'default-dashboard-pannesAbonnement';
export const TRANSACTIONS = 'default-dashboard-transactions';
export const ABONNEMENTS = 'default-dashboard-abonnements';
