<template>
    <div>
        ...
        <smart-select v-else-if="type === 'smart-select'" :key="'smart-select'" :data="$props" :value="value"
                      @input="input"/>

        <search-select v-else-if="type === 'search-select'" :key="'search-select'" :data="$props" :value="value"
                       @input="input"/>

        <select-input v-else-if="type === 'select'" :key="'select'" :data="$props" :value="value" v-on="$listeners"/>

        <multi-select v-else-if="type === 'multi-select'" :key="'multi-select'" :data="$props" :value="value"
                      @input="input"/>

        <text-area v-else-if="type === 'textarea'" :key="'textarea'" :data="$props" :value="value"
                   v-on="$listeners"/>

        <currency v-else-if="type === 'currency'" :key="'currency'" :data="$props" :value="value"
                  v-on="$listeners"/>

        <radio-buttons v-else-if="type === 'radio-buttons'" :key="'radio-buttons'" :data="$props" :value="value"
                       @input="input"/>
        ...
        <check-box v-else-if="type === 'checkbox'" :key="'checkbox'" :data="$props" :value="value"
                   @input="input" @changed="getEvent"/>

        <text-editor v-else-if="type === 'text-editor'" :key="'text-editor'" :data="$props" :value="value"
                     @input="input"/>
        ...
        <custom-image-file-uploader v-else-if="type === 'custom-file-upload'" :key="'custom-file-upload'" :data="$props"
                                    :value="value"
                                    v-on="$listeners"/>

        <dropzone-uploader v-else-if="type === 'dropzone'" :data="$props" :value="value" @input="input"
                           :key="'dropzone'"/>
