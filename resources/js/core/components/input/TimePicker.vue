                    ...
                    <ul class="p-0">
                        <li class="dropdown-item py-2">
                            ...
                            <label class="customized-radio radio-default">
                                <input type="radio" class="radio-inline" name="TimeFormat" id="customRadioAm"
                                       :checked="formatTxtAM" @click="selectAmPM('AM')">
                                <span class="outside">
                                    <span class="inside"/>
                                </span>
                                AM
                        ...
                        <li class="dropdown-item py-2">
                            ...
                            <label class="customized-radio radio-default">
                                <input type="radio" class="radio-inline" name="TimeFormat" id="customRadioPm"
                                       :checked="!formatTxtAM" @click="selectAmPM('PM')">
                                <span class="outside">
                                    <span class="inside"/>
                                </span>
                                PM
