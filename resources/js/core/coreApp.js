...
Vue.component("app-toaster", require('./components/toaster/Toaster').default);
...
Vue.component("app-filter-with-search", require('./components/calendar/FilterWithSearch').default);
...
Vue.component('app-tenant-preview-card', require('./components/tenant-preview-card/AppTenantPreviewCard').default);
