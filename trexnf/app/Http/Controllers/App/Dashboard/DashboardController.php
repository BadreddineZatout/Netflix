...
class DashboardController extends Controller
{
    ...
    public function pannesAbonnement()
    {
        return PanneAbonnement::select('panne_abonnements.id', 'abonnements.email', 'panne_abonnements.date', 'panne_abonnements.heure', 'pannes.panne', 'panne_abonnements.Etat')
                                ...
                                ->orderBy('panne_abonnements.id', 'desc')
                                ->get();
    }
    ...
    {
        return PanneAbonnement::select('panne_abonnements.id', 'abonnements.email', 'panne_abonnements.date', 'panne_abonnements.heure', 'pannes.panne', 'panne_abonnements.Etat')->where('revendeur', Auth::user()->id)->join('abonnements', 'abonnements.id', '=', 'panne_abonnements.abonnement')->join('pannes', 'pannes.id', '=', 'panne_abonnements.panne')
                                ->orderBy('panne_abonnements.id', 'desc')
                                ->get();
    }
    ...
    {
        return PanneAbonnement::select('panne_abonnements.id', 'abonnements.email', 'panne_abonnements.date', 'panne_abonnements.heure', 'pannes.panne', 'panne_abonnements.Etat')->where('panne_abonnements.Etat', 'pending')->join('abonnements', 'abonnements.id', '=', 'panne_abonnements.abonnement')->join('pannes', 'pannes.id', '=', 'panne_abonnements.panne')
                                ->orderBy('panne_abonnements.id', 'desc')
                                ->get();
    }
    public function getAbonnAdmin()
    {
        return Abonnement::where('resultatcreation', 'pending')
                        ->orderBy('id', 'desc')
                        ->get();
    }
