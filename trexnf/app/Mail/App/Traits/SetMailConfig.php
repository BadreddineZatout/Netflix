...
class SetMailConfig
{
    ...
    public function set()
    {
        ...
        if ($mailSettings) {
            ...
            } elseif($mailSettings['provider'] == 'mandrill'){

                Config::set('services.mandrill.secret', $mailSettings['mandrill_key']);

            } elseif($mailSettings['provider'] == 'sparkpost'){

                Config::set('services.sparkpost.secret', $mailSettings['sparkpost_key']);

            }
//            elseif ($mailSettings['provider'] == 'sendmail') {
//                config::set('mail.sendmail', $mailSettings['sendmail_path']);
//            }
        }
    }
}