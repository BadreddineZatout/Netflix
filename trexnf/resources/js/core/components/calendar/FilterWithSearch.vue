<template>
    <div class="row">
        <div class="col-6 col-sm-8 col-md-9 col-lg-10 col-xl-10">
            <div v-if="options.showFilter" class="filters-wrapper d-flex justify-content-start flex-wrap">
                ...
                <span v-show="isFiltersOpen" class="mobile-filters-wrapper">
                        <app-filter :table-id="id" :filters="options.filters" @get-values="getFilterValues"/>
        ...
        <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2">
            <div v-if="options.showSearch" class="mr-0 single-filter single-search-wrapper">
